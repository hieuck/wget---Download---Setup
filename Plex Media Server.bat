...
set "Link="
set "LinkForAllWindows32bit=https://downloads.plex.tv/plex-media-server-new/!SoftNameVersion!/windows/PlexMediaServer-!SoftNameVersion!-x86.exe"
set "LinkForAllWindows64bit=https://downloads.plex.tv/plex-media-server-new/!SoftNameVersion!/windows/PlexMediaServer-!SoftNameVersion!-x86_64.exe"

set "LinkFromGithub="
set "LinkFromDropbox="
set "LinkFromOneDrive="

set "SoftPath=%ProgramFiles%\Plex\Plex Media Server"
