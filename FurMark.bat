...
:: Source link: https://www.geeks3d.com/dl/get/717

if %ARCH%==x86 (
	set "SOFTPATH=%PROGRAMFILES%\Geeks3D\Benchmarks\FurMark"
) else (
	set "SOFTPATH=%PROGRAMFILES(X86)%\Geeks3D\Benchmarks\FurMark"
)

set "LINK=https://geeks3d.com/downloads/2023p/FurMark_1.34.0.0_Setup.exe"
