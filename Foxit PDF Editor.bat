...
set "FileName="
set "SoftNameVersion=12.1.3"
set "FileDLwB=FoxitPDFEditor*.exe"
...
REM Source Link: https://www.foxit.com/downloads/pdf-editor-thanks.html?product=Foxit-PhantomPDF-Business&platform=Windows&version=12.1.2.15332&package_type=exe&language=English&formId=download-phantom-bussiness&form=submit

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://cdn01.foxitsoftware.com/product/phantomPDF/desktop/win/!SoftNameVersion!/FoxitPDFEditor!SoftNameVersion:.=!_enu_Setup_Website.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\Foxit Software\Foxit PDF Editor"
set "SoftPathFor64bit=%ProgramFiles(x86)%\Foxit Software\Foxit PDF Editor"

set "QuietMode=/q /norestart"

set "Cr4ckFile=FoxitPDFEditorCr4ck"
set "Cr4ckPath="
