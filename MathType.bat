...
set "Link=https://downloads.wiris.com/mathtype/windows/MathType-win-en-!SoftNameVersion!.exe"
...
set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\MathType"
set "SoftPathFor64bit=%ProgramFiles(x86)%\MathType"
