...
set "FILENAME=StartAllBack-HieuckIT.exe"
...
set "LINK=https://www.startallback.com/download.php"
set "QUIETMODE=/elevated /silent"
set "CR4CKFILE=StartAllBackCr4ck.rar"
set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/StartAllBackCr4ck/StartAllBackCr4ck.rar"
set "SOFTPATH=%PROGRAMFILES%\StartAllBack"
