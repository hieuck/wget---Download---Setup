...
:: Source link: https://github.com/YerongAI/Office-Tool/releases/latest

if %ARCH%==x86 (
	set "LINK=https://github.com/YerongAI/Office-Tool/releases/download/v10.1.7.1/Office_Tool_with_runtime_v10.1.7.1_x86.zip"
) else (
	set "LINK=https://github.com/YerongAI/Office-Tool/releases/download/v10.1.7.1/Office_Tool_with_runtime_v10.1.7.1_x64.zip"
)
