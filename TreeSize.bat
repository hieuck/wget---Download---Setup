...
set "QuietMode=/SILENT /SUPPRESSMSGBOXES /PASSWORD=4LGX7A-5TR7AX-JDZ2VK-UU5DHV-ZXSULR-4A3AMJ-5VEFLX"

set "Cr4ckFile=TreeSizeCr4ck"
set "Cr4ckPath=%ProgramData%\JAM Software\Licenses"
