...
set "FileName="
set "SoftNameVersion="
set "FileDLwB=JD2SilentSetup*.exe"
...
set "Link="
set "LinkForAllWindows32bit=http://installer.jdownloader.org/JD2SilentSetup_x86.exe"
set "LinkForAllWindows64bit=http://installer.jdownloader.org/JD2SilentSetup_x64.exe"
