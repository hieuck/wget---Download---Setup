...
set "SoftName=TrafficMonitor"
set "Process=TrafficMonitor.exe"
...
REM Source Link: https://github.com/zhongyang219/TrafficMonitor/releases
...
set "Link="
set "LinkForAllWindows32bit=https://github.com/zhongyang219/TrafficMonitor/releases/download/!SoftNameVersion!/TrafficMonitor_!SoftNameVersion!_x86.zip""
set "LinkForAllWindows64bit=https://github.com/zhongyang219/TrafficMonitor/releases/download/!SoftNameVersion!/TrafficMonitor_!SoftNameVersion!_x64.zip"
