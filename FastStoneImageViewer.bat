...
set "Link=https://www.faststone.org/DN/FSViewerSetup!SoftNameVersion!.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\FastStone Image Viewer"
set "SoftPathFor64bit=%ProgramFiles(x86)%\FastStone Image Viewer"
