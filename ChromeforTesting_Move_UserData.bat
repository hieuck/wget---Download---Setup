...
set "ChromePath=!DriveChar!:\Google\Chrome for Testing"
...
xcopy "%LocalAppData%\Google\Chrome for Testing" "!ChromePath!" /I /E /Y>> %Temp%\hieuckitlog.txt
...
cd "%LocalAppData%\Google\Chrome for Testing" &pushd "%LocalAppData%\Google\Chrome for Testing"
start. &popd
cd "!ChromePath!" &pushd "!ChromePath!"
start. &popd
pause

rmdir "%LocalAppData%\Google\Chrome for Testing" /s /q>> %Temp%\hieuckitlog.txt
...
mklink /D "%LocalAppData%\Google\Chrome for Testing" "!ChromePath!">> %Temp%\hieuckitlog.txt
