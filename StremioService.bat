...
set "SoftName=Stremio Service"
set "Process=stremio-service.exe"

set "FileName="
set "SoftNameVersion=0.1.6"
...
REM Source Link: https://www.stremio.com/download-service

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://dl.strem.io/stremio-service/v!SoftNameVersion!/StremioServiceSetup.exe"
