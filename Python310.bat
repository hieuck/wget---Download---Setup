...
set "SoftName=Python310"
set "Process=python.exe"

set "FileName="
set "SoftNameVersion=3.10.11"
set "FileDLwB=python*.exe"
...
set "Link="
set "LinkForAllWindows32bit=https://www.python.org/ftp/python/3.10.11/python-3.10.11.exe"
set "LinkForAllWindows64bit=https://www.python.org/ftp/python/3.10.11/python-3.10.11-amd64.exe"
