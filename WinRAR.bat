...
REM Source Link: https://www.rarlab.com/download.htm
...
set "Link="
set "LinkForAllWindows32bit=https://www.rarlab.com/rar/winrar-x32-!SoftNameVersion!.exe"
set "LinkForAllWindows64bit=https://www.rarlab.com/rar/winrar-x64-!SoftNameVersion!.exe"
