...
set "Process=Screenpresso.exe"

set "FileName="
set "SoftNameVersion=2.1.13.0"
set "FileDLwB=Screenpresso*.exe"
...
REM Source Link: https://www.screenpresso.com/download/
...
set "LinkForAllWindows64bit=https://www.screenpresso.com/binaries/releases/stable/dotnet47/Screenpresso.exe"
...
"%SoftPath%\%Process%" license --activate [3]-[screenpressopro]-[1314]-[Meffi/tPORt]-[11/10/2022]-[CCmBVJV+jaQzzj6K1OypBEp0a4JLoGunMBnIZRsEKNau6wDIOaYGz6pG81MT6JJSeOS/OIdBsMBMzCBHrDBHgQ==] --quiet
