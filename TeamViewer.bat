...
set "Link="
set "LinkForAllWindows32bit=https://download.teamviewer.com/download/TeamViewer_Setup.exe"
set "LinkForAllWindows64bit=https://download.teamviewer.com/download/TeamViewer_Setup_x64.exe"
