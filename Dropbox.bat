...
set "SoftName=Dropbox"
set "Process=Dropbox.exe"
...
REM Source Link: https://www.dropbox.com/home

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://www.dropbox.com/download?os=win"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath="
set "SoftPathFor32bit="
set "SoftPathFor64bit=%ProgramFiles(x86)%\Dropbox\Client"
