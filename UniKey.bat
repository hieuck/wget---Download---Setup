...
set "Link="
set "LinkForAllWindows32bit=https://www.unikey.org/assets/release/unikey45RC1-230808-win32.zip"
set "LinkForAllWindows64bit=https://www.unikey.org/assets/release/unikey45RC1-230808-win64.zip"
