...
set "Link="
set "LinkForAllWindows32bit=https://www.unikey.org/assets/release/unikey46RC2-230919-win32.zip"
set "LinkForAllWindows64bit=https://www.unikey.org/assets/release/unikey46RC2-230919-win64.zip"
