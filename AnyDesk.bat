...
set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\AnyDesk"
set "SoftPathFor64bit=%ProgramFiles(x86)%\AnyDesk"

set "QuietMode=--install "!SoftPath!" --start-with-win --create-shortcuts --create-desktop-icon --update-disabled --silent"
