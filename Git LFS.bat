...
set "SoftName=Git LFS"
set "Process=git-lfs.exe"

set "FileName="
set "SoftNameVersion=3.4.0"
set "FileDLwB=git-lfs*.exe"
...
set "Link=https://github.com/git-lfs/git-lfs/releases/download/v!SoftNameVersion!/git-lfs-windows-v!SoftNameVersion!.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath=%ProgramFiles%\Git LFS"
