...
set "Link="
set "LinkForAllWindows32bit=https://www.voidtools.com/Everything-1.4.1.1022.x86-Setup.exe"
set "LinkForAllWindows64bit=https://www.voidtools.com/Everything-1.4.1.1022.x64-Setup.exe"
