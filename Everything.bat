...
set "SoftName=Everything"
set "Process=Everything.exe"

set "FileName="
set "SoftNameVersion=1.4.1.1024"
set "FileDLwB=Everything*.exe"
...
REM Source Link: https://www.voidtools.com/downloads/
...
set "Link="
set "LinkForAllWindows32bit=https://www.voidtools.com/Everything-!SoftNameVersion!.x86-Setup.exe"
set "LinkForAllWindows64bit=https://www.voidtools.com/Everything-!SoftNameVersion!.x64-Setup.exe"

set "LinkFromGithub="
set "LinkFromDropbox="
set "LinkFromOneDrive="

set "SoftPath=%ProgramFiles%\Everything"
