...
set "License=Yes"
set "Shortcut=No"
set "SOFTNAME=AirLiveDrive"
set "FILENAME=AirLiveDrive-HieuckIT.exe"
set "PROCESS=AirLiveDrive.exe"
...
set "LINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/AirLiveDriveProCr4ck/AirLiveDrive-OfflineInstaller.exe"
set "QUIETMODE=/S"
set "CR4CKFILE=AirLiveDriveProCr4ck.rar"
set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/AirLiveDriveProCr4ck/AirLiveDriveProCr4ck.rar"
