...
REM Source Link: https://www.capcut.com/vi-vn/

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://lf16-capcut.faceulv.com/obj/capcutpc-packages-us/packages/CapCut_!SoftNameVersion!_capcutpc_0_creatortool.exe"
