...
set "BitwardenVersion=2023.4.0"
set "LINK=https://github.com/bitwarden/clients/releases/download/desktop-v%BitwardenVersion%/Bitwarden-Installer-%BitwardenVersion%.exe"
set "QUIETMODE=/S"
