...
REM Source Link: https://github.com/dnSpy/dnSpy/releases/latest
...
set "Link="
set "LinkForAllWindows32bit=https://github.com/dnSpy/dnSpy/releases/download/!SoftNameVersion!/dnSpy-net-win32.zip"
set "LinkForAllWindows64bit=https://github.com/dnSpy/dnSpy/releases/download/!SoftNameVersion!/dnSpy-net-win64.zip"
