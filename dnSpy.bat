...
set "Link="
set "LinkForAllWindows32bit=https://github.com/dnSpy/dnSpy/releases/download/v6.1.8/dnSpy-net-win32.zip"
set "LinkForAllWindows64bit=https://github.com/dnSpy/dnSpy/releases/download/v6.1.8/dnSpy-net-win64.zip"
