...
REM Source Link: https://www.revouninstaller.com/revo-uninstaller-free-download/
...
set "SoftPath=%ProgramFiles%\VS Revo Group\Revo Uninstaller Pro"
set "SoftPathFor32bit="
set "SoftPathFor64bit="

set "QuietMode=/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-"

set "Cr4ckFile=RevoUninstallerCr4ck"
set "Cr4ckPath=%ProgramData%\VS Revo Group\Revo Uninstaller Pro"
