...
set "Link=https://www.timesynctool.com/NetTimeSetup-!SoftNameVersion!.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\NetTime"
set "SoftPathFor64bit=%ProgramFiles(x86)%\NetTime"
