...
set "License=Yes"
set "Shortcut=No"
set "SOFTNAME=AirCluster"
set "FILENAME=AirCluster-HieuckIT.exe"
...
set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/AirClusterProCr4ck/AirClusterProCr4ck.rar"
