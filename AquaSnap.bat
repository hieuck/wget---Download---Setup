...
set "Link=https://www.nurgo-software.com/download/AquaSnap.msi"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "LinkFromGithub=AquaSnap-!SoftNameVersion!.msi"
set "LinkFromDropbox="
set "LinkFromOneDrive="

set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\AquaSnap"
set "SoftPathFor64bit=%ProgramFiles(x86)%\AquaSnap"
