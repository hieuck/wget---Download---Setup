...
set "SOFTNAME=RapidTyping"
set "FILENAME=RapidTyping-HieuckIT.exe"
set "PROCESS=RapidTyping.exe"
set "LINK64=https://rapidtyping.com/en/downloads/typing-tutor/ver-5/RapidTyping_Setup_5.4.exe"
set "LINK32=https://rapidtyping.com/en/downloads/typing-tutor/ver-5/RapidTyping_Setup_5.4_x32.exe"
set "QUIETMODE=/S"
set "Admin="
set "SOFTLOCATION=%PROGRAMFILES%\RapidTyping 5\RapidTyping.exe"
...
if exist "%SOFTLOCATION%" (
	...
	set "SHORTCUTNAME=RapidTyping 5.lnk"
	set "SHORTCUTPATH=%PUBLIC%\Desktop\%SHORTCUTNAME%"
) else (
	echo The file "%PROCESS%" does not exist in directory "%SOFTNAME%". Exiting script.
	exit /b 1
)
