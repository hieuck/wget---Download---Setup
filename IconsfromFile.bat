...
set "SoftName=Icons from File"
set "Process=extraico.exe"

set "FileName="
set "SoftNameVersion=5.1.1"
set "FileDLwB=exico*.exe"
...
REM Source Link: https://www.vlsoftware.net/files/exico.zip

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Setup/exico.exe"
...
set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\Icons from File"
set "SoftPathFor64bit=%ProgramFiles(x86)%\Icons from File"
