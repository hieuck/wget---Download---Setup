...
set "SoftName=FastStone MaxView"
set "Process=MaxView.exe"

set "FileName="
set "SoftNameVersion=34"
set "FileDLwB=FSMaxViewSetup*.exe"
...
set "Link=https://www.faststone.org/DN/FSMaxViewSetup!SoftNameVersion!.exe"
...
set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\FastStone MaxView"
set "SoftPathFor64bit=%ProgramFiles(x86)%\FastStone MaxView"

set "QuietMode=/S"

set "Cr4ckFile=FastStone-MaxView-Cr4ck"
set "Cr4ckPath=%LocalAppData%\FastStone\FSMV"
