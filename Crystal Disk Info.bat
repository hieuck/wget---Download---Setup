...
set "License="
set "Extract7z="
set "SoftName=Crystal Disk Info"
set "Process=DiskInfo64.exe"
if /i "%ARCH%"=="x86" set "Process=DiskInfo32.exe"
set "SupportOldWindows=Yes"
set "Support32Bit=Yes"
set "UserAgent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"

:: Set code based on Windows Architecture
:: Source Link: https://crystalmark.info/redirect.php?product=CrystalDiskInfoInstaller

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://free.nchc.org.tw/osdn//crystaldiskinfo/78192/CrystalDiskInfo8_17_14.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath=%ProgramFiles%\CrystalDiskInfo"
