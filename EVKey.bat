...
if /i "%ARCH%"=="x86" set "Process=EVKey32.exe"

set "FileName="
set "SoftNameVersion=5.0.1"
set "FileDLwB=EVKey*"
...
REM Source Link: https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Setup/EVKey.zip
