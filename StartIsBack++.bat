...
if %ARCH%==x86 (
	set "SOFTPATH=%PROGRAMFILES%\StartIsBack"
) else (
	set "SOFTPATH=%PROGRAMFILES(X86)%\StartIsBack"
)

set "LINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Setup/StartIsBack.exe"
