...
set "Admin="
set "License="
set "SOFTNAME=Google Chrome"
set "FILENAME=Google Chrome-HieuckIT.msi"
set "PROCESS=Chrome.exe"
set "USERAGENT=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"

:: Set code based on Windows Architecture
if %ARCH%==x86 (
	set "LINK=https://dl.google.com/dl/chrome/install/googlechromestandaloneenterprise32.msi"
) else (
