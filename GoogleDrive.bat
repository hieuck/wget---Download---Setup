...
set "Link=https://dl.google.com/drive-file-stream/GoogleDriveSetup.exe"
...
set "SoftPath=%ProgramFiles%\Google\Drive File Stream"
set "SoftPathFor32bit="
set "SoftPathFor64bit="

set "QuietMode=--silent"
