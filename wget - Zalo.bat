...
set "SOFTNAME=Zalo"
set "FILENAME=Zalo-HieuckIT.exe"
set "PROCESS=Zalo.exe"
set "LINK64=https://res-download-pc-te-vnno-pt-6.zadn.vn/hybrid/ZaloSetup-23.3.1.exe"
set "LINK32=https://zalo.me/download/zalo-pc"
set "QUIETMODE=/S"
set "Admin="
set "SOFTLOCATION=%LOCALAPPDATA%\Programs\Zalo\Zalo.exe"
