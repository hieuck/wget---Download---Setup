...
REM Source Link: https://www.videolan.org/vlc/
...
set "Link="
set "LinkForAllWindows32bit=https://mirror.downloadvn.com/videolan/vlc/!SoftNameVersion!/win32/vlc-!SoftNameVersion!-win32.exe"
set "LinkForAllWindows64bit=https://mirror.downloadvn.com/videolan/vlc/!SoftNameVersion!/win64/vlc-!SoftNameVersion!-win64.exe"

set "LinkFromGithub="
set "LinkFromDropbox="
set "LinkFromOneDrive="

set "SoftPath=%ProgramFiles%\VideoLAN\VLC"
