...
set "SoftName=BatteryMon"
set "Process=BatteryMonx64.exe"
if /i "%ARCH%"=="x86" set "Process=BatteryMon.exe"
...
REM Source Link: https://www.passmark.com/products/batmon/

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://www.passmark.com/downloads/batmon.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath=%ProgramFiles%\BatteryMon"
