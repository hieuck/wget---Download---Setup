...
set "License="
set "Extract7z="
set "SOFTNAME=Heaven Benchmark"
set "PROCESS=heaven.bat"
...
set "LINK=https://assets.unigine.com/d/Unigine_Heaven-4.0.exe"
set "QUIETMODE=/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-"
set "SOFTPATH=%PROGRAMFILES(X86)%\Unigine\Heaven Benchmark 4.0"
