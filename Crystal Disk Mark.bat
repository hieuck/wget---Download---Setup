...
set "SoftName=Crystal Disk Mark"
set "Process=DiskMark64.exe"
if /i "%ARCH%"=="x86" set "Process=DiskMark32.exe"
...
:: Source Link: https://crystalmark.info/redirect.php?product=CrystalDiskMarkInstaller

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://ftp.halifax.rwth-aachen.de/osdn/crystaldiskmark/77936/CrystalDiskMark8_0_4c.exe"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath=%ProgramFiles%\CrystalDiskMark8"
