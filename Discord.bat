...
set "SoftName=Discord"
set "Process=Update.exe"

set "FileName="
set "SoftNameVersion="
set "FileDLwB=Discord*.exe"
...
REM Source Link: https://discord.com/download

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://discord.com/api/downloads/distributions/app/installers/latest?channel=stable&platform=win&arch=x86"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "SoftPath=%LocalAppData%\Discord"
