...
if %ARCH%==x86 (
	...
	set "SOFTPATH=%PROGRAMFILES(X86)%\FastStone Image Viewer"
)
...
if "%License%"=="Yes" (
	...
	set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Cr4ck/FastStoneImageViewerCr4ck.rar"
