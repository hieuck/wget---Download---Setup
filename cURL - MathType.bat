...
set "LINK=https://downloads.wiris.com/mathtype/windows/MathType-win-en-7.5.0.125.exe"
set "QUIETMODE=/S"
...
if "%License%"=="Yes" (
	...
	set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Cr4ck/MathTypeCr4ck.rar"
