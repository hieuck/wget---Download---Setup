...
set "License=Yes"
set "Shortcut=No"
set "SOFTNAME=MathType"
set "FILENAME=MathType-HieuckIT.exe"
...
if %ARCH%==x86 (
	set "SOFTPATH=%PROGRAMFILES%\MathType"
) else (
	set "SOFTPATH=%PROGRAMFILES(X86)%\MathType"
)
set "LINK=https://downloads.wiris.com/mathtype/windows/MathType-win-en-7.4.10.53.exe"
set "QUIETMODE=/S"
set "CR4CKFILE=MathTypeCr4ck.rar"
set "CR4CKLINK=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/MathTypeCr4ck/MathTypeCr4ck.rar"
