...
set "LINK64=https://sourceforge.net/projects/qbittorrent/files/qbittorrent-win32/qbittorrent-4.5.2/qbittorrent_4.5.2_lt20_qt6_x64_setup.exe/download"
set "LINK32=danvaoday"
set "QUIETMODE=/S"
set "Admin="
set "SOFTLOCATION=%PROGRAMFILES%\qBittorrent\qbittorrent.exe"
