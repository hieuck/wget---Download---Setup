...
set "LINK64=https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.5.2/npp.8.5.2.Installer.x64.exe"
set "LINK32=https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.5.2/npp.8.5.2.Installer.exe"
set "QUIETMODE=/S"
set "Admin="
set "SOFTLOCATION=%PROGRAMFILES%\Notepad++\notepad++.exe"
