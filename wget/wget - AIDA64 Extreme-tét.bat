...
@echo off
set KEY=UR55D-QFID6-NJDJZ-ADMA1-GTWDD
echo %KEY% > %Temp%\Key_AIDA64.txt
echo Activating AIDA64...
start "" "%SOFTLOCATION%"
timeout 5
:: Send key to AIDA64 window
powershell -command "$wshell = New-Object -ComObject wscript.shell; Start-Sleep -s 1; $wshell.AppActivate('AIDA64 Extreme / Engineer Edition Activation'); Start-Sleep -s 1; $wshell.SendKeys('%{h}e'); Start-Sleep -s 1; $wshell.SendKeys('%{n}'); Start-Sleep -s 1; $wshell.SendKeys('%{v}'); Start-Sleep -s 1; $wshell.SendKeys('%{s}'); Start-Sleep -s 1; $wshell.SendKeys('%{a}'); Start-Sleep -s 1; $wshell.SendKeys('%{p}'); Start-Sleep -s 1; $wshell.SendKeys('%{x}'); Start-Sleep -s 1; $wshell.SendKeys('%{f4}'); Start-Sleep -s 1; $wshell.SendKeys('{ENTER}');"
echo Successfully Cr4cked %SOFTNAME%.
