...
set "Admin="
set "License="
set "SOFTNAME=PaperCut Mobility Print"
set "FILENAME=PaperCut Mobility Print-HieuckIT.exe"
set "PROCESS=mobility-print.exe"
...
set "LINK=https://cdn.papercut.com/web/products/mobility-print/installers/server/windows/pc-mobility-print-1.0.3512.exe"
set "QUIETMODE=/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-"
set "CR4CKFILE=danvaoday.rar"
set "CR4CKLINK=danvaoday"
set "SOFTPATH=%PROGRAMFILES(X86)%\PaperCut Mobility Print"
set "SOFTLOCATION=%SOFTPATH%\admin-ui.url"
