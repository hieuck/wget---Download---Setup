...
REM Source Link: https://support.google.com/earth/answer/168344?hl=vi
...
set "Link="
set "LinkForAllWindows32bit=https://dl.google.com/dl/earth/client/advanced/current/googleearthprowin-!SoftNameVersion!.exe"
set "LinkForAllWindows64bit=https://dl.google.com/dl/earth/client/advanced/current/googleearthprowin-!SoftNameVersion!-x64.exe"
