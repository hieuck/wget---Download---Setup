...
if %ARCH%==x86 (
	set "LINK=https://rapidtyping.com/en/downloads/typing-tutor/ver-5/RapidTyping_Setup_5.4_x32.exe"
) else (
	set "LINK=https://rapidtyping.com/en/downloads/typing-tutor/ver-5/RapidTyping_Setup_5.4.exe"
)
set "QUIETMODE=/S"
set "CR4CKFILE=danvaoday.rar"
set "CR4CKLINK=danvaoday"
set "SOFTPATH=%PROGRAMFILES%\RapidTyping 5\"
