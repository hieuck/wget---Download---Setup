...
set "SoftName=TeraCopy"
set "Process=TeraCopy.exe"

set "FileName="
set "SoftNameVersion=3.6"
set "FileDLwB=TeraCopy*exe"
...
set "Link=https://github.com/hieuck/curl-uri-wget-download-setup/raw/main/Setup/TeraCopy.Pro.v3.6.0.4.exe"
...
set "SoftPath=%ProgramFiles%\TeraCopy"
